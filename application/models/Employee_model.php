...
class Employee_model extends CI_Model
{
  ...
  {
    $sql = "SELECT * FROM `employee` WHERE `status` = 'ACTIVE' AND `project` = 'W Project'";
    $query = $this->db->query($sql);
    $result = $query->result();
    return $result;
  }
  ...
  // A method to get all employees (could be used in the controller)
  ...
  {
    $sql = "SELECT * FROM `employee` WHERE `status` = 'ACTIVE' AND `project` = 'ATAS SRI LANKA'";
    $query = $this->db->query($sql);
    $result = $query->result();
    return $result;
  }
  ...
  {
    $sql = "SELECT * FROM `employee` WHERE `status` = 'ACTIVE' AND `project` = 'K8 withdrwal'";
    $query = $this->db->query($sql);
    $result = $query->result();
    return $result;
  }
  ...
  public function getEmployeesByProject($project)
  {
