...
<div class="page-wrapper">
    ...
    <h3 class="text-themecolor"><i class="fa fa-balance-scale" style="color:#1976d2"></i> Disciplinary</h3>
</div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content ">
                                        <div class="modal-header">
                                            <h4 class="modal-title" id="exampleModalLabel1"><i class="fa fa-balance-scale" style="color:#1976d2"></i> Disciplinary Notice</h4>
