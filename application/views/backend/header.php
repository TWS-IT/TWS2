                ...
                <a class="navbar-brand" href="<?php echo base_url(); ?>">
                    ...
                    <span>
                        <img src="<?php echo base_url(); ?>assets/images/<?php echo $settingsvalue->sitelogo; ?>"
                            alt="homepage" class="dark-logo" height="50px" width="70px" />
                    </span>
                </a>
            </div>
                    ...
                    <ul class="navbar-nav my-lg-0">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="#"
                                ...
                                <img src="<?php echo base_url(); ?>assets/images/users/<?php echo $basicinfo->em_image; ?>"
                                    class="profile-pic" style="height:40px;width:40px;border-radius:100px" />
                            </a>
                                ...
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            ...
                                            <div class="u-text">
                                                <h4><?php echo $basicinfo->first_name . ' ' . $basicinfo->last_name; ?>
                                                </h4>
                                    ...
                                    <li><a
                                            href="<?php echo base_url(); ?>employee/view?I=<?php echo base64_encode($basicinfo->em_id); ?>"><i
