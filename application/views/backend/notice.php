...
<?php $this->load->view('backend/sidebar'); ?>
    ...
    <h3 class="text-themecolor"><i class="fa fa-bullhorn" style="color:#1976d2"></i> Notice Board</h3>
</div>
                    ...
                    <div class="col-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                    <h4 class="m-b-0 text-white"><i class="fa fa-bullhorn"></i> Notice</h4>
                            </div>
                            <div class="card-body">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content ">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="exampleModalLabel1"><i class="fa fa-bullhorn"></i> Notice Board</h4>
