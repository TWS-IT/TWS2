...
class W1W_W extends CI_Controller
{
    ...
    public function w1w_w_order_count()
    {
        ...
        $this->load->model('W1w_w_model');  // Ensure correct capitalization
        $this->load->model('Employee_model');  // Ensure correct capitalization

        // Get the sum of order_count from the w1w_w table
        $sum_order_count = $this->W1w_w_model->get_sum_order_count();

        // Get data for the w1w_w table
        $w1w_w = $this->W1w_w_model->get_w1w_w();  // Ensure consistent method naming
    ...
    public function showMistakeChart($project)
    {
        ...
        $this->load->model('w1w_w_Model');
        try {
            $data = $this->w1w_w_Model->getMistakesByProject($project);
