...
class Atas_Order extends CI_Controller
{
    ...
    public function get_all_orders_barline_chart()
    {
        if ($this->session->userdata('user_login_access') != false) {
            ...
            $data = $this->Atas_Model->get_all_orders_for_barline_chart($startDate, $endDate, $shiftid);
    ...
    public function get_filtered_order_sum()
    {
        if ($this->session->userdata('user_login_access') != False) {
            ...
            $this->load->model('atas_model');
            $sum = $this->Atas_Model->get_sum_order_count_by_date($startDate, $endDate, $shiftid);
...
public function showMistakeChart($project)
{
    ...
    $this->load->model('Atas_Model');
    try {
        $data = $this->Atas_Model->getMistakesByProject($project);
